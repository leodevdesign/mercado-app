  ...
  return (
    <div className="bg-white rounded-3xl shadow-md border-2 border-slate-200 overflow-hidden mb-8 transition-all">
      ...
      <button
        ...
        className="w-full p-5 bg-gradient-to-r from-blue-600 to-indigo-700 text-white flex items-center justify-between font-black text-xl hover:from-blue-700 hover:to-indigo-800 transition-all focus:outline-none focus:ring-4 focus:ring-blue-300"
      >
        ...
        <div className="p-6 sm:p-8 space-y-7 bg-slate-50 border-t-2 border-slate-200">
          ...
          {mode === 'guided' && (
            <form onSubmit={handleSubmitGuided} className="space-y-6">
                      ...
                      <button
                        ...
                        className={`px-4 py-3 rounded-2xl font-black text-lg transition-all border-2 ${
                          selectedPreset?.id === preset.id
                            ...
                            : 'bg-slate-50 text-slate-900 border-slate-300 hover:bg-blue-50'
                        }`}
                      >
                        {preset.name}
                      </button>
                ...
                <div className="bg-white p-5 rounded-2xl border-2 border-slate-200 shadow-xs space-y-4">
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <select
                        ...
                        className="w-full h-14 pl-5 pr-14 text-xl font-bold text-slate-900 bg-slate-50 border-2 border-slate-300 rounded-xl focus:border-blue-600 focus:ring-4 focus:ring-blue-200 focus:outline-none appearance-none cursor-pointer"
                      >
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full h-14 px-4 text-lg font-semibold text-slate-900 bg-slate-50 border-2 border-slate-300 rounded-xl mb-3 focus:outline-none focus:ring-4 focus:ring-blue-200"
                    />
                    ...
                    <div className="flex flex-wrap gap-2">
                      {(selectedPreset.suggestedDetails || presetObservations).map((obs, idx) => (
                        <button
                          ...
                          className="px-3.5 py-2 bg-slate-100 hover:bg-blue-100 hover:text-blue-900 rounded-xl font-bold text-sm text-slate-800 border border-slate-300 transition-all"
                        >
                          + {obs}
                        </button>
                      ))}
              ...
              <button
                type="submit"
                className="w-full py-5 px-6 bg-green-600 hover:bg-green-700 active:bg-green-800 text-white font-black text-xl rounded-2xl shadow-lg transition-all hover:scale-[1.01] focus:outline-none focus:ring-4 focus:ring-green-300 flex items-center justify-center gap-2"
              >
            ...
            <form onSubmit={handleSubmitManual} className="space-y-6">
              <div>
                ...
                <input
                  ...
                  className="w-full h-16 px-5 text-xl font-bold text-slate-900 bg-white border-2 border-slate-300 rounded-2xl focus:border-blue-600 focus:ring-4 focus:ring-blue-200 focus:outline-none shadow-xs"
                />
              </div>
                ...
                <div className="bg-white p-5 rounded-2xl border-2 border-slate-200 shadow-xs">
                  ...
                  <div className="relative">
                    <select
                      ...
                      className="w-full h-16 pl-5 pr-14 text-xl font-bold text-slate-900 bg-slate-50 border-2 border-slate-300 rounded-2xl focus:border-blue-600 focus:ring-4 focus:ring-blue-200 focus:outline-none appearance-none cursor-pointer"
                    >
                      {categories.map((cat) => (
                ...
                <div className="bg-white p-5 rounded-2xl border-2 border-slate-200 shadow-xs">
                  ...
                  {manualUnit === 'Personalizada...' && (
                    <input
                      ...
                      className="w-full h-16 px-5 text-xl font-bold text-slate-900 bg-white border-2 border-blue-500 rounded-2xl mt-4 focus:outline-none focus:ring-4 focus:ring-blue-200"
                    />
                  )}
                </div>
              </div>
              ...
              <div className="bg-white p-5 rounded-2xl border-2 border-slate-200 shadow-xs">
                ...
                <input
                  ...
                  className="w-full h-16 px-5 text-xl font-semibold text-slate-900 bg-slate-50 border-2 border-slate-300 rounded-2xl focus:border-blue-600 focus:ring-4 focus:ring-blue-200 focus:outline-none mb-4"
                />
                ...
                <div className="flex flex-wrap gap-2.5">
                  {presetObservations.map((obs) => (
                    <button
                      ...
                      className="px-4 py-2.5 bg-slate-100 hover:bg-blue-100 hover:text-blue-900 rounded-xl font-bold text-base text-slate-800 border-2 border-slate-200 transition-all"
                    >
                      + {obs}
                    </button>
                  ))}
              ...
              <button
                type="submit"
                className="w-full py-5 px-6 bg-blue-600 hover:bg-blue-700 active:bg-blue-800 text-white font-black text-xl rounded-2xl shadow-lg transition-all hover:scale-[1.01] focus:outline-none focus:ring-4 focus:ring-blue-300 flex items-center justify-center gap-2"
              >
